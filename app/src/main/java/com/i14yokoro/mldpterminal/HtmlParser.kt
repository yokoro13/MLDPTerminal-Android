...
object HtmlParser {
    fun toHtml(text: Spannable): String {
        ...
        val styleSpans = ssBuilder.getSpans(0, text.length, StyleSpan::class.java)
        ...
        val underSpans = ssBuilder.getSpans(0, ssBuilder.length, UnderlineSpan::class.java)
    ...
    private fun replace(b: SpannableStringBuilder, oldChar: Char = '\n') {
