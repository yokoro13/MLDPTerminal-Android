...
internal constructor(private val termDisplay: TermDisplay) {
    ...
    fun selectGraphicRendition(n: Int) { //色
        ...
        when (n) {
            0 -> termDisplay.defaultColor = -0x1000000
            30 -> termDisplay.defaultColor = -0x1000000
            31 -> termDisplay.defaultColor = -0x10000
            32 -> termDisplay.defaultColor = -0xff8000
            33 -> termDisplay.defaultColor = -0x100
            34 -> termDisplay.defaultColor = -0xffff01
            35 -> termDisplay.defaultColor = -0xff01
            36 -> termDisplay.defaultColor = -0xff0001
            37 -> termDisplay.defaultColor = -0x1
            39 -> termDisplay.defaultColor = -0x1000000
